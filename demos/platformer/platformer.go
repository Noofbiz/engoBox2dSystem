...
func (*defaultScene) Preload() {
	...
	engoBox2dSystem.InitBox2dSystem(box2d.B2Vec2{X: 0.0, Y: 10.0}, 20.0, 3, 8)
...
func (*defaultScene) Setup(w *ecs.World) {
	...
	//add box2d systems
	w.AddSystem(&engoBox2dSystem.Box2dPhysicsSystem{})
	w.AddSystem(&engoBox2dSystem.Box2dCollisionSystem{})
	...
	dudeBodyDef.Position.X = float64(engoBox2dSystem.PxToMeters(dude.SpaceComponent.Center().X))
	dudeBodyDef.Position.Y = float64(engoBox2dSystem.PxToMeters(dude.SpaceComponent.Center().Y))
	dudeBodyDef.Angle = float64(engoBox2dSystem.DegToRad(dude.SpaceComponent.Rotation))
	...
	dudeBodyShape.SetAsBox(float64(engoBox2dSystem.PxToMeters(dude.SpaceComponent.Width/2)),
		float64(engoBox2dSystem.PxToMeters(dude.SpaceComponent.Height/2)))
	...
	grassBodyDef.Position.X = float64(engoBox2dSystem.PxToMeters(grass.SpaceComponent.Center().X))
	grassBodyDef.Position.Y = float64(engoBox2dSystem.PxToMeters(grass.SpaceComponent.Center().Y))
	grassBodyDef.Angle = float64(engoBox2dSystem.DegToRad(grass.SpaceComponent.Rotation))
	grass.Box2dComponent.Body = engoBox2dSystem.World.CreateBody(grassBodyDef)
	var grassBodyShape box2d.B2PolygonShape
	grassBodyShape.SetAsBox(float64(engoBox2dSystem.PxToMeters(grass.SpaceComponent.Width/2)),
		float64(engoBox2dSystem.PxToMeters(grass.SpaceComponent.Height/2)))
	...
	grass1BodyDef.Position.X = float64(engoBox2dSystem.PxToMeters(grass1.SpaceComponent.Center().X))
	grass1BodyDef.Position.Y = float64(engoBox2dSystem.PxToMeters(grass1.SpaceComponent.Center().Y))
	grass1BodyDef.Angle = float64(engoBox2dSystem.DegToRad(grass1.SpaceComponent.Rotation))
	grass1.Box2dComponent.Body = engoBox2dSystem.World.CreateBody(grass1BodyDef)
	var grass1BodyShape box2d.B2PolygonShape
	grass1BodyShape.SetAsBox(float64(engoBox2dSystem.PxToMeters(grass1.SpaceComponent.Width/2)),
		float64(engoBox2dSystem.PxToMeters(grass1.SpaceComponent.Height/2)))
	...
	grass2BodyDef.Position.X = float64(engoBox2dSystem.PxToMeters(grass2.SpaceComponent.Center().X))
	grass2BodyDef.Position.Y = float64(engoBox2dSystem.PxToMeters(grass2.SpaceComponent.Center().Y))
	grass2BodyDef.Angle = float64(engoBox2dSystem.DegToRad(grass2.SpaceComponent.Rotation))
	grass2.Box2dComponent.Body = engoBox2dSystem.World.CreateBody(grass2BodyDef)
	var grass2BodyShape box2d.B2PolygonShape
	grass2BodyShape.SetAsBox(float64(engoBox2dSystem.PxToMeters(grass2.SpaceComponent.Width/2)),
		float64(engoBox2dSystem.PxToMeters(grass2.SpaceComponent.Height/2)))
	...
	leftWallBodyDef.Position.X = float64(engoBox2dSystem.PxToMeters(leftWall.SpaceComponent.Center().X))
	leftWallBodyDef.Position.Y = float64(engoBox2dSystem.PxToMeters(leftWall.SpaceComponent.Center().Y))
	leftWallBodyDef.Angle = float64(engoBox2dSystem.DegToRad(leftWall.SpaceComponent.Rotation))
	leftWall.Box2dComponent.Body = engoBox2dSystem.World.CreateBody(leftWallBodyDef)
	var leftWallBodyShape box2d.B2PolygonShape
	leftWallBodyShape.SetAsBox(float64(engoBox2dSystem.PxToMeters(leftWall.SpaceComponent.Width/2)),
		float64(engoBox2dSystem.PxToMeters(leftWall.SpaceComponent.Height/2)))
	...
	rightWallBodyDef.Position.X = float64(engoBox2dSystem.PxToMeters(rightWall.SpaceComponent.Center().X))
	rightWallBodyDef.Position.Y = float64(engoBox2dSystem.PxToMeters(rightWall.SpaceComponent.Center().Y))
	rightWallBodyDef.Angle = float64(engoBox2dSystem.DegToRad(rightWall.SpaceComponent.Rotation))
	...
	rightWallBodyShape.SetAsBox(float64(engoBox2dSystem.PxToMeters(rightWall.SpaceComponent.Width/2)),
		float64(engoBox2dSystem.PxToMeters(rightWall.SpaceComponent.Height/2)))
	...
	ceilBodyDef.Position.X = float64(engoBox2dSystem.PxToMeters(ceil.SpaceComponent.Center().X))
	ceilBodyDef.Position.Y = float64(engoBox2dSystem.PxToMeters(ceil.SpaceComponent.Center().Y))
	ceilBodyDef.Angle = float64(engoBox2dSystem.DegToRad(ceil.SpaceComponent.Rotation))
	ceil.Box2dComponent.Body = engoBox2dSystem.World.CreateBody(ceilBodyDef)
	var ceilBodyShape box2d.B2PolygonShape
	ceilBodyShape.SetAsBox(float64(engoBox2dSystem.PxToMeters(ceil.SpaceComponent.Width/2)),
		float64(engoBox2dSystem.PxToMeters(ceil.SpaceComponent.Height/2)))
	...
	for i := 0; i < 7; i++ {
		...
		starBodyDef.Position.X = float64(engoBox2dSystem.PxToMeters(star.SpaceComponent.Center().X))
		starBodyDef.Position.Y = float64(engoBox2dSystem.PxToMeters(star.SpaceComponent.Center().Y))
		starBodyDef.Angle = float64(engoBox2dSystem.DegToRad(star.SpaceComponent.Rotation))
		...
		vertices = append(vertices, box2d.B2Vec2{X: float64(engoBox2dSystem.PxToMeters(0)), Y: float64(engoBox2dSystem.PxToMeters(-50))})
		vertices = append(vertices, box2d.B2Vec2{X: float64(engoBox2dSystem.PxToMeters(49)), Y: float64(engoBox2dSystem.PxToMeters(-15))})
		vertices = append(vertices, box2d.B2Vec2{X: float64(engoBox2dSystem.PxToMeters(30)), Y: float64(engoBox2dSystem.PxToMeters(41))})
		vertices = append(vertices, box2d.B2Vec2{X: float64(engoBox2dSystem.PxToMeters(-31)), Y: float64(engoBox2dSystem.PxToMeters(41))})
		vertices = append(vertices, box2d.B2Vec2{X: float64(engoBox2dSystem.PxToMeters(-50)), Y: float64(engoBox2dSystem.PxToMeters(-15))})
...
func (s *starCollectionSystem) New(w *ecs.World) {
	engo.Mailbox.Listen("Box2dCollisionStartMessage", func(message engo.Message) {
		c, isCollision := message.(engoBox2dSystem.Box2dCollisionStartMessage)
		if isCollision {
